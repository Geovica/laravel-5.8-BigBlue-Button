...
```
 geotechee\Bigbluebutton\BigbluebuttonProviderService::class,
```
You can optionally use the facade for shorter code. Add this to your facades:
```
'Meeting' => geotechee\Bigbluebutton\BigbluebuttonMeeting::class,
```
...
{
    /**
     * @var \geotechee\Bigbluebutton\Contracts\Meeting
     */
    protected $meeting;
...
**Create meeting**
```php
use geotechee\Bigbluebutton\Contracts\Meeting;
